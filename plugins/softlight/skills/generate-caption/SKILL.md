...
description: Generate a caption that summarizes a change to an application.
---
...
Specification of the change to the application to describe.

# Output

Generate a caption for the `<spec>` that summarizes the change to the application.
