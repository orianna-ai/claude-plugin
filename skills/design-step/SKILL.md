...
Dispatch reviews for completed explorations that haven't been reviewed yet. Don't go deeper
on an exploration you just sent for review — that's a convergence decision and you need the
feedback to make it well. When review feedback has landed on the canvas, use it to decide
which prototypes to take deeper and at what level.
